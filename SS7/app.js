...
/*
Bài toán: Kiểm tra điều kiện đầu vào học sinh và xếp loại học lực như sau
+ 10  -> 8.5: Giỏi
+ 8.5 -> 6.5: Khá
+ 6.5 -> 5.0: Trung bình 
+ 5.0 -> 3.0: Kém
...
let diem = 1.1; // có thể thay đổi để test thuật toán
if (diem <= 10 && diem >= 8.5) { // Cả 2 điều kiện đồng thời đúng
  console.log("Giỏi");
}
else if (diem < 8.5 && diem >= 6.5) { // điều kiện con (vị trí: nằm giữa if và else)
  console.log("Khá");
}
